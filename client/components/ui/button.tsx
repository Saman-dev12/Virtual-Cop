...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-br from-orange-500 to-orange-700 hover:from-orange-600 hover:to-orange-800 text-white shadow-lg shadow-orange-600/20 hover:shadow-orange-600/40",
        outline:
          "border border-orange-500 text-orange-500 hover:bg-orange-500/10 hover:text-orange-500",
        destructive:
      ...
      size: {
        ...
        icon: "h-9 w-9",
        xl: "px-6 py-2 sm:px-8 text-base sm:text-lg",
      },
    },
    defaultVariants: {
      variant: "default",
