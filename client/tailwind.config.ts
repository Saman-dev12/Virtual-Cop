...
const config: Config = {
  ...
  theme: {
  	extend: {
  		...
  		backgroundImage: {
  			'orange-gradient': 'linear-gradient(to right, hsl(var(--orange-400)), hsl(var(--orange-700)))',
  			'orange-gradient-radial': 'radial-gradient(circle, hsl(var(--orange-400)), hsl(var(--orange-700)))'
  		},
  		boxShadow: {
